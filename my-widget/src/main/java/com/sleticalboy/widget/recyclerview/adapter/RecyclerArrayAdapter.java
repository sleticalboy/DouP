...
abstract public class RecyclerArrayAdapter<T> extends RecyclerView.Adapter<BaseViewHolder> {
     ...
     */
    public View setMore(final View view, final OnLoadMoreListener listener) {
    ...
    public View setMore(final int res, final OnMoreListener listener) {
        FrameLayout container = new FrameLayout(getContext());
        container.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
        LayoutInflater.from(getContext()).inflate(res, container);
    ...
    public View setMore(final View view, OnMoreListener listener) {
    ...
    public View setNoMore(final View view, OnNoMoreListener listener) {
        getEventDelegate().setNoMore(view, listener);
        return view;
    }

    public View setNoMore(final int res, OnNoMoreListener listener) {
        FrameLayout container = new FrameLayout(getContext());
        container.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
        LayoutInflater.from(getContext()).inflate(res, container);
    ...
    public View setError(final int res, OnErrorListener listener) {
        FrameLayout container = new FrameLayout(getContext());
        container.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
        LayoutInflater.from(getContext()).inflate(res, container);
    ...
    public View setError(final View view, OnErrorListener listener) {
    ...
    public final int getItemCount() {
        return mDataList.size() + headers.size() + footers.size();
    }
